...
//
//  CA_MDiscoverFinancingSectionView.m
//  InvestNote_iOS
//
//  Created by 野猪哥 on 2018/6/11.
//  Copyright © 2018年 韩云智. All rights reserved.
//

#import "CA_MDiscoverFinancingSectionView.h"

@interface CA_MDiscoverFinancingSectionView ()

@property (nonatomic,strong) UILabel *titleLb;

@end

@implementation CA_MDiscoverFinancingSectionView
...
-(void)setTotalCount:(NSNumber *)totalCount{
    ...
    NSString *str = [NSString stringWithFormat:@"搜索到 %@ 条企业融资信息",countStr];
    ...
    [attrStr addAttribute:NSForegroundColorAttributeName value:CA_H_9GRAYCOLOR range:NSMakeRange(str.length-7, 7)];
