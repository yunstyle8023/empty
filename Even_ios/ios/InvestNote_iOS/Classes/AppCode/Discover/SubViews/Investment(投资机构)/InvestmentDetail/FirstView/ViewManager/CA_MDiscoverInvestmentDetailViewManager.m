...
//
//  CA_MDiscoverInvestmentDetailViewManager.m
//  InvestNote_iOS
//
...
@interface CA_MDiscoverInvestmentDetailViewManager ()
@property (nonatomic,assign) CGFloat headerHeight;
@end

@implementation CA_MDiscoverInvestmentDetailViewManager
...
-(void)configViewWithModel:(CA_MDiscoverInvestmentDetailModel *)model block:(void (^)(CGFloat))block{
    CA_H_WeakSelf(self)
    [self.headerView configViewWithModel:model block:^(CGFloat height) {
        CA_H_StrongSelf(self)
        self.frame = self.headerView.titleLb.frame;
...
-(UITableView *)tableView{
    if (!_tableView) {
        ...
        [_tableView registerClass:[CA_MDiscoverSponsorDetailItemCell class] forCellReuseIdentifier:@"DetailItemCell"];
        [_tableView registerClass:[CA_MDiscoverInvestmentDetailIntroCell class] forCellReuseIdentifier:@"DetailIntroCell"];
...
-(CA_MDiscoverInvestmentDetailHeaderView *)headerView{
    if (!_headerView) {
        _headerView = [CA_MDiscoverInvestmentDetailHeaderView new];
    }
    return _headerView;
}
