...
- (MYColorBackView *)colorBackView
{
    if (!_colorBackView) {
        ...
        if (self.isNeedClearBack) {
            ...
            _colorBackView.backColorView.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.35];
            CGFloat height = kDevice_Is_iPhoneX?88:64;
            if (_showFrame.origin.y > height) {
                _colorBackView.topView.backgroundColor   = kColor(@"#04040F");
                _colorBackView.topView.alpha = 0.35;
            }
        }
